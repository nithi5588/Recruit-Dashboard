...
function availabilityDotColor(text: string) {
  if (/available in/i.test(text)) return "#F59E0B";
  return "#22C55E";
}
...
function priorityBadgeTone(p: Candidate["priority"]): {
  ...
  if (p === "High") return { bg: "#FEF2F2", fg: "#DC2626" };
  if (p === "Medium") return { bg: "#FFF4DB", fg: "#B45309" };
  return { bg: "#F3F4F8", fg: "#667085" };
}
...
function CandidateCard({
  ...
  return (
    <article className="group relative flex flex-col rounded-[14px] border border-[color:var(--color-border)] bg-[color:var(--color-surface)] p-4 transition-all hover:-translate-y-[2px] hover:border-[color:var(--color-brand-200)] hover:shadow-[0_10px_24px_rgba(91,61,245,0.10)]">
...
export function CandidatesPageClient() {
  ...
  return (
    <div className="min-w-0 space-y-5 px-4 py-6 sm:px-6 xl:px-8 xl:py-8">
            ...
            <div className="rounded-[12px] border border-[color:var(--color-border)] bg-[color:var(--color-surface-2)]/40 p-3 sm:p-4">
              ...
              <div className="mt-3 flex items-center justify-end gap-2">
                ...
                <button
                  ...
                  className="inline-flex h-9 items-center rounded-[10px] bg-[color:var(--color-brand-500)] px-4 text-[13px] font-semibold text-white shadow-[0_4px_12px_rgba(91,61,245,0.25)] transition-colors hover:bg-[color:var(--color-brand-600)]"
                >
                  Done
                </button>
              </div>
      ...
      {/* ── Bulk selection bar ───────────────────────── */}
      {selected.size > 0 ? (
        <div className="flex flex-wrap items-center justify-between gap-3 rounded-[14px] border border-[color:var(--color-brand-200)] bg-[color:var(--color-brand-50)] px-4 py-3 shadow-[0_4px_14px_rgba(91,61,245,0.08)]">
