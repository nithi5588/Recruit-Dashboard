...
const PRIORITY_STYLES: Record<FollowupPriority, { bg: string; fg: string }> = {
  ...
  Medium: { bg: "#FFF4DB", fg: "#B45309" },
  Low:    { bg: "#EAFBF1", fg: "#16A34A" },
};
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-[3fr_4fr_3fr]">
        <div className="rounded-[18px] border border-[color:var(--color-border)] bg-gradient-to-br from-[#EEE9FF] via-white to-white p-5 shadow-[var(--shadow-card)]">
            ...
            <table className="w-full min-w-[620px] text-left">
              ...
              <tbody>
                {upcomingFollowups.map((f) => (
                  <tr key={f.candidate}
                    className={`border-b border-[color:var(--color-border)] last:border-0 text-[12px] ${f.overdue ? "bg-[#FDECEC]/30" : ""}`}>
