export const reportStatCards = [
  ...
  { label: "Interviews",       value: 18,  change: 12, icon: "calendar",  iconBg: "#F5F3FF", iconColor: "#8B5CF6" }, // violet
  { label: "Offers",           value: 7,   change: 16, icon: "check",     iconBg: "#FFFBEB", iconColor: "#F59E0B" }, // amber
  { label: "Placements",       value: 4,   change: 33, icon: "trophy",    iconBg: "#FFF1F2", iconColor: "#F43F5E" }, // rose
];
...
export const sourceData = [
  { label: "LinkedIn",        count: 24, pct: 42.9, color: "#6366F1" }, // indigo
  { label: "Company Careers", count: 12, pct: 21.4, color: "#10B981" }, // emerald
  { label: "Referral",        count:  8, pct: 14.3, color: "#F59E0B" }, // amber
  { label: "Naukri",          count:  6, pct: 10.7, color: "#8B5CF6" }, // violet
  { label: "Indeed",          count:  4, pct:  7.1, color: "#06B6D4" }, // cyan
  { label: "Others",          count:  2, pct:  3.6, color: "#94A3B8" }, // slate
];

// Funnel stays in a single hue family — it visually represents narrowing
// progression. Indigo gradient from light → deep gives a cleaner read than
// random hues per stage.
export const funnelData = [
  { label: "Profiles Added",    count: 126, color: "#A5B4FC" },
  { label: "Applications Sent", count:  56, color: "#818CF8" },
  { label: "Interviews",        count:  18, color: "#6366F1" },
  { label: "Offers",            count:   7, color: "#4F46E5" },
  { label: "Placements",        count:   4, color: "#3730A3" },
];

export const interviewStageData = [
  { label: "Screening Call",    count: 7, pct: 38.9, color: "#6366F1" }, // indigo
  { label: "Technical Round",   count: 5, pct: 27.8, color: "#06B6D4" }, // cyan
  { label: "HR Round",          count: 3, pct: 16.7, color: "#8B5CF6" }, // violet
  { label: "Managerial Round",  count: 2, pct: 11.1, color: "#10B981" }, // emerald
  { label: "Final Round",       count: 1, pct:  5.5, color: "#F59E0B" }, // amber
];
...
export const followUpsData = [
  { label: "Completed", count: 16, pct: 57.1, color: "#10B981" }, // emerald
  { label: "Pending",   count:  9, pct: 32.1, color: "#F59E0B" }, // amber
  { label: "Overdue",   count:  3, pct: 10.8, color: "#F43F5E" }, // rose
];

export const recentActivities = [
  { name: "Savannah Nguyen",    action: "Interview scheduled", role: "Product Designer",  time: "10:30 AM",     type: "interview",   initials: "SN", color: "#8B5CF6" }, // violet
  { name: "Ralph Edwards",      action: "Application submitted",role: "Frontend Developer",time: "9:15 AM",     type: "application", initials: "RE", color: "#06B6D4" }, // cyan
  { name: "Dianne Russell",     action: "Follow-up pending",   role: "Marketing Manager", time: "Yesterday",    type: "followup",    initials: "DR", color: "#F59E0B" }, // amber
  { name: "Cameron Williamson", action: "Offer accepted",      role: "Product Manager",   time: "Yesterday",    type: "offer",       initials: "CW", color: "#10B981" }, // emerald
  { name: "Esther Howard",      action: "Interview completed", role: "UX Researcher",     time: "May 15, 2024", type: "interview",   initials: "EH", color: "#8B5CF6" }, // violet
];
...
export const jobsStatCards = [
  ...
  { label: "Jobs Conversion Rate",    value: "21.4%", change: 14, icon: "percent",   iconBg: "#C4CBF6", iconColor: "#20319C" },
];
...
export const jobsByStatus = [
  ...
  { label: "Expired", count:  1, pct:  4.2, color: "#A3A3A3" },
];
...
export const jobsApplicationsBySource = [
  ...
  { label: "Indeed",          count: 16, pct:  6.3, color: "#A3A3A3" },
  { label: "Others",          count:  8, pct:  3.1, color: "#A3A3A3" },
];
...
export const jobsByDepartment = [
  ...
  { label: "Data",        count:  2, pct:  8.3, color: "#A3A3A3" },
];
...
export const candidateStatCards = [
  ...
  { label: "High Priority",    value: "14",  change:  8, icon: "star",      iconBg: "#C4CBF6", iconColor: "#20319C" },
];
...
export const candidatesByStage = [
  ...
  { label: "Placed",       count:  7, pct:  7.7, color: "#273DC0" },
  { label: "Rejected",     count: 15, pct: 16.5, color: "#A3A3A3" },
];
...
export const topSkillsInDemand = [
  ...
  { skill: "AWS",        candidates: 24, color: "#A3A3A3" },
];
...
export const candidatesByLocation = [
  ...
  { label: "Chicago",       count: 12, pct:  9.5, color: "#A3A3A3" },
  { label: "Others",        count: 10, pct:  7.9, color: "#A3A3A3" },
];
...
export const recruiterPerformance = [
  { name: "Emma Rodriguez", initials: "ER", color: "#5C6FE7", candidates: 32, submissions: 18, interviews: 8, placements: 3, conversion:  9.4 },
  { name: "Liam Chen",      initials: "LC", color: "#96A3EF", candidates: 28, submissions: 15, interviews: 6, placements: 2, conversion:  7.1 },
  { name: "Sophia Patel",   initials: "SP", color: "#273DC0", candidates: 26, submissions: 14, interviews: 7, placements: 4, conversion: 15.4 },
  { name: "Noah Kim",       initials: "NK", color: "#5C6FE7", candidates: 22, submissions: 12, interviews: 5, placements: 1, conversion:  4.5 },
  { name: "Olivia Brown",   initials: "OB", color: "#A3A3A3", candidates: 18, submissions: 10, interviews: 4, placements: 2, conversion: 11.1 },
];
...
export const interviewStatCards = [
  ...
  { label: "Interview → Offer Rate",value: "28%", change:   8, icon: "trophy",   iconBg: "#F2F3FD", iconColor: "#5C6FE7", positive: true  },
];
...
export const topInterviewers = [
  { name: "Priya Shah",      initials: "PS", color: "#5C6FE7", interviews: 12, rating: 4.8 },
  { name: "Marcus Johnson",  initials: "MJ", color: "#96A3EF", interviews: 10, rating: 4.6 },
  { name: "Aisha Khan",      initials: "AK", color: "#273DC0", interviews:  8, rating: 4.7 },
  { name: "Daniel Martinez", initials: "DM", color: "#5C6FE7", interviews:  7, rating: 4.5 },
  { name: "Rachel O'Brien",  initials: "RO", color: "#A3A3A3", interviews:  5, rating: 4.9 },
];

export const interviewOutcomes = [
  { label: "Passed",      count: 16, pct: 38.1, color: "#273DC0" },
  { label: "Failed",      count:  6, pct: 14.3, color: "#20319C" },
  { label: "No-Show",     count:  2, pct:  4.8, color: "#A3A3A3" },
  { label: "Rescheduled", count:  4, pct:  9.5, color: "#5C6FE7" },
  { label: "Pending",     count: 14, pct: 33.3, color: "#96A3EF" },
];
...
export const avgTimePerStage = [
  ...
  { label: "Final → Offer",         days: 2.1, color: "#A3A3A3" },
];

export const upcomingInterviews = [
  { name: "Savannah Nguyen",    role: "Product Designer",   stage: "Technical",  time: "Today, 2:30 PM",  color: "#5C6FE7", initials: "SN" },
  { name: "Ralph Edwards",      role: "Frontend Dev",       stage: "Screening",  time: "Today, 4:00 PM",  color: "#96A3EF", initials: "RE" },
  { name: "Dianne Russell",     role: "Marketing Manager",  stage: "Final",      time: "Tomorrow, 10 AM", color: "#A3A3A3", initials: "DR" },
  { name: "Cameron Williamson", role: "Product Manager",    stage: "HR",         time: "Tomorrow, 3 PM",  color: "#273DC0", initials: "CW" },
  { name: "Esther Howard",      role: "UX Researcher",      stage: "Managerial", time: "May 20, 11 AM",   color: "#5C6FE7", initials: "EH" },
];
...
export const activityStatCards = [
  ...
  { label: "Peak Hour",         value: "2 PM", change: null, icon: "clock",    iconBg: "#C4CBF6", iconColor: "#20319C", subtitle: "Most activity logged" },
] as const;
...
export const activityTypeBreakdown = [
  ...
  { label: "Notes",        count: 38, pct: 11.1, color: "#A3A3A3" },
  { label: "Follow-ups",   count: 26, pct:  7.6, color: "#A3A3A3" },
];
...
export const activitiesByRecruiter = [
  { name: "Sophia Patel",    initials: "SP", color: "#5C6FE7", count: 72 },
  { name: "Emma Rodriguez",  initials: "ER", color: "#96A3EF", count: 65 },
  { name: "Liam Chen",       initials: "LC", color: "#273DC0", count: 58 },
  { name: "Olivia Brown",    initials: "OB", color: "#5C6FE7", count: 54 },
  { name: "Noah Kim",        initials: "NK", color: "#A3A3A3", count: 48 },
  { name: "Aarav Mehta",     initials: "AM", color: "#C4CBF6", count: 45 },
];
...
export const activityFeed: ActivityFeedItem[] = [
  ...
  { id: "6",  group: "Yesterday", type: "note",        actor: { name: "Sophia Patel",   initials: "SP", color: "#5C6FE7" }, title: "Added candidate note", subject: "Priority flagged: ‘Strong React fit’", time: "3:04 PM" },
  { id: "7",  group: "Yesterday", type: "offer",       actor: { name: "Emma Rodriguez", initials: "ER", color: "#96A3EF" }, title: "Offer accepted",       subject: "Cameron Williamson · Product Manager", time: "10:11 AM" },
  { id: "8",  group: "Earlier This Week", type: "call",      actor: { name: "Noah Kim",     initials: "NK", color: "#A3A3A3" }, title: "Screening call completed", subject: "Ralph Edwards · 22 min", time: "May 16, 4:45 PM" },
  { id: "9",  group: "Earlier This Week", type: "interview", actor: { name: "Aisha Khan",   initials: "AK", color: "#273DC0" }, title: "HR round completed",       subject: "Savannah Nguyen · Product Designer", time: "May 16, 2:30 PM" },
  { id: "10", group: "Earlier This Week", type: "email",     actor: { name: "Aarav Mehta",  initials: "AM", color: "#C4CBF6" }, title: "Nurture campaign sent",    subject: "12 candidates · React pool", time: "May 15, 9:00 AM" },
];
...
export const followupStatCards = [
  ...
  { label: "Avg. Response Time",  value: "4.2h", change: -18, icon: "bolt",   iconBg: "#F2F3FD", iconColor: "#5C6FE7", positive: true  },
];
...
export const followupStatusDonut = [
  { label: "Completed", count: 58, pct: 67.4, color: "#273DC0" },
  { label: "Pending",   count: 21, pct: 24.4, color: "#5C6FE7" },
  { label: "Overdue",   count:  7, pct:  8.2, color: "#20319C" },
];

// Stacked horizontal bar — priority distribution
export const followupPriority = [
  { label: "High",   count: 18, pct: 20.9, color: "#20319C" },
  { label: "Medium", count: 42, pct: 48.8, color: "#5C6FE7" },
  { label: "Low",    count: 26, pct: 30.3, color: "#273DC0" },
];
...
export const followupByChannel = [
  ...
  { label: "In-person",  count:  3, color: "#A3A3A3" },
];
...
export const upcomingFollowups: Array<{
  ...
  { candidate: "Ralph Edwards",      initials: "RE", color: "#96A3EF", role: "Frontend Developer", due: "Today, 3:00 PM",     priority: "High",   channel: "Call",     assigned: "Sophia P" },
  { candidate: "Dianne Russell",     initials: "DR", color: "#A3A3A3", role: "Marketing Manager",  due: "Today, 5:00 PM",     priority: "High",   channel: "Email",    assigned: "Emma R" },
  { candidate: "Savannah Nguyen",    initials: "SN", color: "#5C6FE7", role: "Product Designer",   due: "Tomorrow, 10:00 AM", priority: "Medium", channel: "Call",     assigned: "Liam C" },
...
export const teamStatCards = [
  ...
  { label: "Avg. Rating",        value: "4.7",   change: null, icon: "star",   iconBg: "#C4CBF6", iconColor: "#20319C", subtitle: "Out of 5.0 across 42 reviews" },
] as const;
...
export const teamLeaderboard = [
  { rank: 1, name: "Sophia Patel",    initials: "SP", color: "#5C6FE7", placements: 4, score: 94, trend: 2  },
  { rank: 2, name: "Emma Rodriguez",  initials: "ER", color: "#96A3EF", placements: 3, score: 88, trend: 0  },
  { rank: 3, name: "Liam Chen",       initials: "LC", color: "#273DC0", placements: 2, score: 82, trend: 1  },
  { rank: 4, name: "Olivia Brown",    initials: "OB", color: "#5C6FE7", placements: 2, score: 76, trend: -1 },
  { rank: 5, name: "Noah Kim",        initials: "NK", color: "#A3A3A3", placements: 1, score: 68, trend: 0  },
  { rank: 6, name: "Aarav Mehta",     initials: "AM", color: "#C4CBF6", placements: 0, score: 54, trend: 0  },
];
...
export const recruiterGoals = [
  { name: "Sophia Patel",   initials: "SP", color: "#5C6FE7", target: 5, actual: 4 },
  { name: "Emma Rodriguez", initials: "ER", color: "#96A3EF", target: 4, actual: 3 },
  { name: "Liam Chen",      initials: "LC", color: "#273DC0", target: 4, actual: 2 },
  { name: "Olivia Brown",   initials: "OB", color: "#5C6FE7", target: 3, actual: 2 },
  { name: "Noah Kim",       initials: "NK", color: "#A3A3A3", target: 3, actual: 1 },
];
...
export const teamMatrix: Array<{
  ...
  { name: "Sophia Patel",    initials: "SP", color: "#5C6FE7", candidates: 26, submissions: 14, interviews: 7, offers: 5, placements: 4, conversion: 15.4, rating: 4.9, trend: "up"   },
  { name: "Emma Rodriguez",  initials: "ER", color: "#96A3EF", candidates: 32, submissions: 18, interviews: 8, offers: 4, placements: 3, conversion:  9.4, rating: 4.7, trend: "up"   },
  { name: "Liam Chen",       initials: "LC", color: "#273DC0", candidates: 28, submissions: 15, interviews: 6, offers: 3, placements: 2, conversion:  7.1, rating: 4.6, trend: "up"   },
  { name: "Olivia Brown",    initials: "OB", color: "#5C6FE7", candidates: 18, submissions: 10, interviews: 4, offers: 3, placements: 2, conversion: 11.1, rating: 4.5, trend: "down" },
  { name: "Noah Kim",        initials: "NK", color: "#A3A3A3", candidates: 22, submissions: 12, interviews: 5, offers: 2, placements: 1, conversion:  4.5, rating: 4.4, trend: "flat" },
  { name: "Aarav Mehta",     initials: "AM", color: "#C4CBF6", candidates: 16, submissions:  8, interviews: 3, offers: 1, placements: 0, conversion:  0.0, rating: 4.3, trend: "flat" },
];
...
export const recruitmentPulse = {
  ...
  delta: 9,
  narrative: [
    { icon: "🚀", label: "Applications sent",    value: "56",  change: 25, color: "#06B6D4" },
    { icon: "📅", label: "Interviews scheduled", value: "18",  change: 12, color: "#8B5CF6" },
    { icon: "🎯", label: "Offers accepted",      value: "7",   change: 16, color: "#F59E0B" },
    { icon: "🏆", label: "Placements made",      value: "4",   change: 33, color: "#10B981" },
  ],
...
export const jobPipelineFlow = [
  ...
  { title: "Data Analyst",       icon: "📊", stages: [186, 18,  7, 3, 1, 0], color: "#A3A3A3" },
];
...
export const todaySchedule: InterviewSlot[] = [
  { id: "i1", hourStart:  9.5, duration: 45, candidate: { name: "Ralph Edwards",    initials: "RE", color: "#96A3EF" }, role: "Frontend Developer", stage: "Screening",  interviewer: "Sophia P" },
  { id: "i2", hourStart: 10.5, duration: 60, candidate: { name: "Savannah Nguyen", initials: "SN", color: "#5C6FE7" }, role: "Product Designer",   stage: "Technical",  interviewer: "Priya S"  },
  { id: "i3", hourStart: 13.0, duration: 45, candidate: { name: "Cameron Williamson", initials: "CW", color: "#273DC0" }, role: "Product Manager",  stage: "HR",         interviewer: "Marcus J" },
  { id: "i4", hourStart: 14.0, duration: 60, candidate: { name: "Dianne Russell",  initials: "DR", color: "#A3A3A3" }, role: "Marketing Manager",  stage: "Final",      interviewer: "Aisha K"  },
  { id: "i5", hourStart: 15.5, duration: 45, candidate: { name: "Esther Howard",   initials: "EH", color: "#5C6FE7" }, role: "UX Researcher",      stage: "Managerial", interviewer: "Rachel O" },
  { id: "i6", hourStart: 16.5, duration: 30, candidate: { name: "Marcus Lee",      initials: "ML", color: "#C4CBF6" }, role: "Data Analyst",       stage: "Screening",  interviewer: "Daniel M" },
];
