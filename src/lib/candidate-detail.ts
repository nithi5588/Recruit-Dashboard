...
const savannah: CandidateDetail = {
  ...
  tools: [
    ...
    { label: "InVision", abbr: "In", bg: "#E6E9FB", fg: "#20319C" },
    { label: "Notion", abbr: "N", bg: "#F5F5F5", fg: "#0A0A0A" },
  ],
  experience: [
    {
    ...
    applications: [
      {
        ...
        company: "Figma",
        logo: { abbr: "F", bg: "#C4CBF6", fg: "#20319C" },
        status: "In Progress",
      ...
      },
      {
        ...
        company: "Adobe",
        logo: { abbr: "A", bg: "#C4CBF6", fg: "#20319C" },
        status: "Under Review",
      ...
      },
      {
        ...
        company: "Shopify",
        logo: { abbr: "S", bg: "#E6E9FB", fg: "#20319C" },
        status: "Shortlisted",
      ...
      },
      {
        ...
        jobTitle: "Product Designer",
        company: "Atlassian",
        logo: { abbr: "A", bg: "#EAEAEA", fg: "#525252" },
        status: "Rejected",
  ...
  skillsBlock: {
    ...
    otherSkills: [
      ...
      { name: "Miro", level: "Intermediate", abbr: "M", bg: "#F2F3FD", fg: "#273DC0" },
      { name: "Zeplin", level: "Intermediate", abbr: "Z", bg: "#F2F3FD", fg: "#273DC0" },
    ],
    topMatchSkills: [
      { name: "Product Design", percent: 95, abbr: "PD", iconBg: "#E6E9FB", iconFg: "#20319C" },
      { name: "UI/UX Design", percent: 92, abbr: "UI", iconBg: "#F2F3FD", iconFg: "#273DC0" },
      { name: "Figma", percent: 90, abbr: "F", iconBg: "#C4CBF6", iconFg: "#20319C" },
      { name: "User Research", percent: 85, abbr: "UR", iconBg: "#EAEAEA", iconFg: "#525252" },
