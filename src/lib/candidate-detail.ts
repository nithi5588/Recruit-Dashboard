...
const savannah: CandidateDetail = {
  ...
  tools: [
    { label: "Figma", abbr: "Fig", bg: "#F8D5BD", fg: "#9F430D" },
    { label: "Sketch", abbr: "Sk", bg: "#FFF6EE", fg: "#C75510" },
    { label: "Adobe XD", abbr: "Xd", bg: "#FCE9DD", fg: "#EA6814" },
    { label: "Photoshop", abbr: "Ps", bg: "#E8E4DC", fg: "#6B6358" },
    { label: "Illustrator", abbr: "Ai", bg: "#FFF6EE", fg: "#C75510" },
    { label: "InDesign", abbr: "Id", bg: "#FCE9DD", fg: "#9F430D" },
    { label: "InVision", abbr: "In", bg: "#FCE9DD", fg: "#9F430D" },
    { label: "Notion", abbr: "N", bg: "#F4F2EE", fg: "#1F1B17" },
  ],
  experience: [
    {
  ...
  applicationsBlock: {
    ...
    applications: [
      {
        ...
        company: "Figma",
        logo: { abbr: "F", bg: "#F8D5BD", fg: "#9F430D" },
        status: "In Progress",
      ...
      },
      {
        ...
        company: "Adobe",
        logo: { abbr: "A", bg: "#F8D5BD", fg: "#9F430D" },
        status: "Under Review",
      ...
      },
      {
        ...
        jobTitle: "Product Designer",
        company: "Atlassian",
        logo: { abbr: "A", bg: "#E8E4DC", fg: "#6B6358" },
        status: "Rejected",
    ...
    funnel: [
      { name: "Applied", count: 4, color: "#EA6814" },
      { name: "Screening", count: 1, color: "#6B6358" },
      { name: "Interview", count: 2, color: "#EA6814" },
      { name: "Offered", count: 0, color: "#ED8E55" },
      { name: "Rejected", count: 1, color: "#9F430D" },
    ],
    topApplied: {
      jobTitle: "Senior Product Designer",
      company: "Figma",
  ...
  activityBlock: {
    ...
    byType: [
      { name: "Status Updates", count: 4, percent: 33, color: "#EA6814" },
      { name: "Notes", count: 3, percent: 25, color: "#6B6358" },
      { name: "Interviews", count: 2, percent: 17, color: "#EA6814" },
      { name: "Applications", count: 2, percent: 17, color: "#ED8E55" },
      { name: "Others", count: 1, percent: 8, color: "#9F430D" },
    ],
    activities: [
      {
  ...
  skillsBlock: {
    ...
    otherSkills: [
      { name: "Adobe XD", level: "Intermediate", abbr: "Xd", bg: "#FCE9DD", fg: "#EA6814" },
      { name: "Sketch", level: "Intermediate", abbr: "Sk", bg: "#FFF6EE", fg: "#C75510" },
      { name: "Webflow", level: "Beginner", abbr: "W", bg: "#E8E4DC", fg: "#6B6358" },
      { name: "HTML/CSS", level: "Beginner", abbr: "H5", bg: "#FFF6EE", fg: "#C75510" },
      { name: "Miro", level: "Intermediate", abbr: "M", bg: "#FFF6EE", fg: "#C75510" },
      { name: "Zeplin", level: "Intermediate", abbr: "Z", bg: "#FFF6EE", fg: "#C75510" },
    ],
    topMatchSkills: [
      { name: "Product Design", percent: 95, abbr: "PD", iconBg: "#FCE9DD", iconFg: "#9F430D" },
      { name: "UI/UX Design", percent: 92, abbr: "UI", iconBg: "#FFF6EE", iconFg: "#C75510" },
      { name: "Figma", percent: 90, abbr: "F", iconBg: "#F8D5BD", iconFg: "#9F430D" },
      { name: "User Research", percent: 85, abbr: "UR", iconBg: "#E8E4DC", iconFg: "#6B6358" },
      { name: "Prototyping", percent: 80, abbr: "P", iconBg: "#FFF6EE", iconFg: "#C75510" },
    ],
    categories: [
      { name: "Design", count: 8, color: "#EA6814" },
      { name: "Research", count: 3, color: "#EA6814" },
      { name: "Tools", count: 5, color: "#6B6358" },
  ...
  projectsBlock: {
    ...
    byRole: [
      { name: "Product Designer", count: 4, color: "#EA6814" },
      { name: "UI/UX Designer", count: 3, color: "#6B6358" },
      { name: "UX Designer", count: 1, color: "#EA6814" },
    ],
    topSkills: [
